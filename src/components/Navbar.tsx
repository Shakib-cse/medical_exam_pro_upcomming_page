    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-3 sm:px-6 pt-3 sm:pt-4 pb-2 transition-all duration-300">
      ...
      >
        ...
        <div className="hidden lg:flex items-center gap-2 bg-[#041322]/80 border border-[#1D82EB]/30 rounded-full px-3.5 py-1 text-xs text-slate-300">
          ...
          <span className="font-semibold text-white tracking-wide">LAUNCHING 15 OCTOBER</span>
          <span className="text-slate-500">|</span>
          <span className="text-[#38BDF8] font-medium flex items-center gap-1">
            <ShieldCheck className="w-3.5 h-3.5" /> Secret Launch Perks
          </span>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          <button
            ...
            className="hidden sm:inline-flex items-center gap-1.5 text-xs font-semibold text-slate-300 hover:text-white px-3 py-2 rounded-full hover:bg-white/5 transition-colors"
          >
            Try Mini Case
          </button>

          <button
            onClick={() => scrollToSection("vip-waitlist")}
            className="group relative inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3.5 sm:px-5 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-bold text-white bg-gradient-to-r from-[#FF6B00] to-[#ff8c3a] shadow-lg shadow-[#FF6B00]/30 hover:shadow-[#FF6B00]/50 hover:scale-[1.02] active:scale-95 transition-all whitespace-nowrap cursor-pointer"
          >
